...
def on_select(selection):  # open the port and command it to start the LED blinking here
  ...
  tgsCom = tgsCom[:5]  # makes tgsCom only have the value of the first four letters/numbers of the selection
...
Test_Label.configure(activebackground = "#33B5E5", relief = FLAT, bg='grey90') #gives the button detail
